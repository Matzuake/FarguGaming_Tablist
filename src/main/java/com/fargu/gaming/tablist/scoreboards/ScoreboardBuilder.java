...
public abstract class ScoreboardBuilder {
    ...
    public ScoreboardBuilder(Player player) {
        this.player = player;
        String servername = ChatColor.translateAlternateColorCodes('&', Tablist.cfg.getString("Prefix.ServerName"));
        ...
        this.objective = this.scoreboard.registerNewObjective("display", "dummy", servername);
